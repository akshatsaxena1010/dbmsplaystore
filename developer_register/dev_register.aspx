<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dev_register.aspx.cs" Inherits="playstore.developer_register.dev_register" %>
...
<body  style="background-image: url(../83.jpg);  background-repeat: no-repeat;   background-size: auto;">
    <h5 style="font-family: 'Times New Roman', Times, serif; color: #FFFFFF; text-align: left; font-style: normal;margin-left:27%;margin-top:10%;font-size: 30px;">Developer Registration</h5>
    ...
    <div style="text-align: center; white-space: normal;float:right;position:absolute;left:10%;top:20%"> 
        <div style=" opacity:0.85; padding: 30px 30px 30px 30px; margin: 50px 250px 50px 250px; border-radius:25px; background-position: center center; color: #000000; font-size: x-large; font-weight: bold; background-color: #f2f2f2; clip: rect(auto, auto, auto, auto); position: static; z-index: auto; display: block; width: 45%; height: 45%;">
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Developer ID" BackColor="#BFBEC2"></asp:TextBox>                  
            <br />
            <br />
            <asp:TextBox ID="TextBox2" runat="server" placeholder="Name" BackColor="#BFBEC2"></asp:TextBox>                  
            <br />
            <br />
            <asp:TextBox ID="TextBox3" runat="server" placeholder="Location" BackColor="#BFBEC2"></asp:TextBox>                                    
            <br />
            <br />
            <br />
